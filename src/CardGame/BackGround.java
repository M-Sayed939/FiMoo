...
import HomeTask.Textures.Example1.AnimGLEventListener;
...
public class BackGround extends AnimListener {

        String textureName = "GreenBack.jpg";
...
//          mipmapsFromPNG(gl, new GLU(), texture[i]);
        ...
        public static void main(String[] args) {
            new Test(new CardGame.BackGround());
        }
